...
public class Configs extends Application {
    ...
    public static String error_toast ="No Internet Connection or server error";
    public static String error_login= "Not a valid user";
