 ...
 */
public class Connected_groups extends Fragment {
    ...
    public Connected_groups newInstance() {
        Connected_groups fragment = new Connected_groups();
        return fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_connected_groups, container, false);
        getActivity().getWindow().setStatusBarColor(getResources().getColor(R.color.main_color));


        // Init views
        streamsListView = view.findViewById(R.id.connected_recycler);
        ...
        noStreamsTxt = view.findViewById(R.id.connNoStreamsTxt);
