...
import static com.domain.mystream.Constants.MyStreamApis.GET_MULTIPLE_CHAT;


public class NewChat extends AppCompatActivity {
    RecyclerView renewchat;
    String checked, userIds;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!userIds.equals(" ") || !userIds.equals("0"))
                    getMultipleUser(user_id, userIds);
            }
        });
    ...
    private void getMultipleUser(String userid, String checked) {
        ...
        StringRequest stringRequest;
        stringRequest = new StringRequest(Request.Method.GET, GET_MULTIPLE_CHAT+"userId=" + userid + "&userIds=" + checked, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                //  Toast.makeText(SignUpActivity.this, response, Toast.LENGTH_LONG).show();
                /*   hideProgress(getActivity());*/
